...
function ajax(t) {
    ...
    success: function (t) {
        if ("Please type a number!" == t) $(".notes").show(), 
        document.getElementById("status").innerHTML = t;
        else if ("Error! The result is too large ( >100000 )" == t) $(".notes").show(), 
        document.getElementById("status").innerHTML = t;
        else {
            var r = $.parseJSON(t),
                n = [];
        ...
        method = t.method ? t.method.toUpperCase() : "POST", "GET" == method) 
        ...
        req.open(method, t.url, !0), t.statbox && (document.getElementById(t.statbox).innerHTML = '<img src="/img/prload.gif">'), 
...
function Reset() {
    ...
    document.calculator.reset(), $("#CPnres").html(""), $("#nobj").val(""), $("#robj").val(""), $("#hres").val("")
}
// Results Page
function Calc_CPnr() {
    var t = "";
    ...
    for (var u = 1; c >= u; u++) p += c > u ? u + "&times;" : u;
        ...
        d += "<tr><td colspan='2'>(r + n - 1)! = (" + o + " + " + s + " - 1)! = " + (o + s - 1) + "!</td></tr>", 
        d += "<tr><td colspan='2'>" + p + "</td></tr>", d += "<tr><td colspan='2'> = " + m + "</td></tr>"
    }
    if ("1" == r && 0 == e || "0" == r && 0 == e) {
        var v = "";
        v = s + "! = ";
    for (var b = 1; s >= b; b++) v += s > b ? b + "&times;" : b;
        var f = nfactorial(s);
        if (d += "<tr><td colspan='2'><b>Find n!</b></td> </tr>", 
            d += "<tr><td colspan='1'>" + v + "</td></tr>", 
            d += "<tr><td colspan='2'> = " + f + "</td></tr>", "0" == r && 0 == e) {
            var h = "";
            h = o + "! = ";
        ...
        var g = nfactorial(c);
            ...
            d += "<tr><td colspan='2'>(n - r)! = (" + s + " - " + o + ")! = " + (s - o) + "!</td></tr>", 
            d += "<tr><td colspan='2'>" + p + "</td></tr>", d += "<tr><td colspan='2'> = " + g + "</td></tr>"
    }
    ...
    if ("1" == r && 0 == e) {
        var j = fnrnd(P, 3);
            ...
            d += "<tr><td colspan='2'>P(" + s + ", " + o + ") = " + f + "/" + g + "</td></tr>", 
            d += "<tr><td colspan='2'><span style='color:red; font-weight:bold'>P(" + s + ", " + o + ") = " + j + "</span></td></tr>", $("#hres").val(j)
    } else if ("1" == r && 1 == e) {
        var j = fnrnd(P, 3);
            d += "<tr><td colspan='2'><b>Result</b></td></tr>", 
            d += "<tr><td colspan='2'><span style='text-decoration:overline'>P</span>(n, r) = n<sup>r</sup></td></tr>", 
            d += "<tr><td colspan='2'><span style='text-decoration:overline'>P</span>(" + s + ", " + o + ") = " + l + " </td></tr>", d += "<tr><td colspan='2'><span style='color:red; font-weight:bold'><span style='text-decoration:overline'>P</span>(" + s + ", " + o + ") = " + i + "</span></td></tr>", $("#hres").val(i)
    }
    if ("0" == r && 1 == e) {
        var h = "";
        h = o + "! = ";
        ...
        var H = nfactorial(s - 1);
            ...
            d += "<tr><td colspan='2'>(n - 1)! = (" + s + " - 1)! = " + (s - 1) + "!</td></tr>", 
            d += "<tr><td colspan='1'>" + v + "</td></tr>", d += "<tr><td colspan='2'> = " + H + "</td></tr>";
        var q = 1 * m / (w * H),
            L = fnrnd(q, 3);
            d += "<tr><td colspan='2'><b>Result</b></td></tr>", 
            d += "<tr><td colspan='2'><span style='text-decoration:overline'>C</span>(n, r) = (r + n - 1)! / (r! * (n - 1)!)</td></tr>", 
            d += "<tr><td colspan='2'><span style='text-decoration:overline'>C</span>(" + s + ", " + o + ") = " + m + " / (" + w + " * " + H + ")</td></tr>", 
            d += "<tr><td colspan='2'><span style='color:red; font-weight:bold'><span style='text-decoration:overline'>C</span>(" + s + ", " + o + ") = " + L + "</span></td></tr>", $("#hres").val(L)
    }
    if ("0" == r && 0 == e) {
        var F = P / I,
            R = fnrnd(F, 3);
            ...
            d += "<tr><td colspan='2'>C(" + s + ", " + o + ") = " + f + " / (" + w + " * " + g + ")</td></tr>", 
            d += "<tr><td colspan='2'><span style='color:red; font-weight:bold'>C(" + s + ", " + o + ") = " + R + "</span></td></tr>", $("#hres").val(R)
    }
